  ...
  return (
    ...
    <form onSubmit={onSubmit} className="fifa-auth-card">
      <div className="text-center mb-4">
        ...
        <h1 className="fifa-auth-title fifa-gradient-text display-4 mb-0">Sign In</h1>
        <p className="fifa-auth-note mb-0">Enter the stadium and secure your seats.</p>
      </div>
      ...
      {errors}
      <button className="btn btn-primary fifa-submit w-100 mt-4">Sign In</button>
    </form>
    </div>
  );
};
